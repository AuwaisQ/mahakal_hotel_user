...
import 'package:mahakal/features/product_details/domain/models/product_details_model.dart';
import 'package:mahakal/features/product_details/screens/product_image_screen.dart';
...
import 'package:mahakal/common/basewidget/not_logged_in_bottom_sheet_widget.dart';
import 'package:mahakal/features/product_details/widgets/favourite_button_widget.dart';
                                    ...
                                    child: Stack(children: [
                                                    ...
                                                    return ClipRRect(
                                                      ...
                                                      child: CustomImageWidget(
                                                          ...
                                                          width: MediaQuery.of(
                                                              ...
                                                              .width,
                                                          image:
                                                              '${splashController.baseUrls!.productImageUrl}/${productModel!.images![index]}'),
                                                    );
                                                  },
                                                  onPageChanged: (index) =>
                                                      productController
                                      ...
                                      Positioned(
                                          ...
                                          child: Row(children: [
                                            ...
                                            InkWell(
                                                onTap: () async {
                                                  // First fetch the link if not already available
                                                  ...
                                                  // Debug print
                                                  print(
                                                      'Current sharableLink value: ${productController.sharableLink}');

                                                  // Then share if available
                                                  if (productController
                                                          .sharableLink !=
                                                      null) {
                                                    print(
                                                        'Sharing: ${productController.sharableLink}');
                                                    await Share.share(
                                                        productController
                                                            .sharableLink!);
                                                  } else {
                                                    print(
                                                        'No sharable link available');
                                                  }
                                                },
                                                child: Card(
                                                    elevation: 2,
