...
import 'package:mahakal/features/address/domain/models/address_model.dart';
import 'package:mahakal/features/auth/widgets/code_picker_widget.dart';
...
import 'package:mahakal/common/basewidget/success_dialog_widget.dart';
...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void prettyPrintAddress(AddressModel addressModel) {
    const JsonEncoder encoder = JsonEncoder.withIndent('  ');
    String prettyAddress = encoder.convert(addressModel.toJson());
    print(prettyAddress);
  }
                            ...
                            child: ClipRRect(
                                ...
                                child:
                                  ...
                                  GoogleMap(
                                      ...
                                      onCameraIdle: () {
                                        if (_updateAddress) {
                                          locationController.updateMapPosition(
                                              _cameraPosition,
                                              true,
                                              null,
                                              context);
                            ...
                            Container(
                                ...
                                child: DropdownButtonFormField2<String>(
                                  dropdownSearchData: DropdownSearchData(
                                    searchController:
                                        addressController.searchZipController,
                                  ...
                                  onTap: locationController.loading
                                      ...
                                      : () {
                                          ...
                                          if (widget.isEnableUpdate) {
                                            ...
                                            prettyPrintAddress(AddressModel(
                                                addressType: addressController
                                                    .addressTypeList[addressController
                                                        .selectAddressIndex]
                                                    .title,
