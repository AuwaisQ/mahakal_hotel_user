...
class Sectionlist {
  ...
  factory Sectionlist.fromJson(Map<String, dynamic> json) => Sectionlist(
        ...
        rightTop: json['right-top'] == null
            ? null
            : Banner.fromJson(json['right-top']),
        rightBottom: json['right-bottom'] == null
            ? null
            : Banner.fromJson(json['right-bottom']),
      );

  Map<String, dynamic> toJson() => {
        'section': section.toJson(),
        'banners': List<dynamic>.from(banners.map((x) => x.toJson())),
        'right-top': rightTop?.toJson(),
        'right-bottom': rightBottom?.toJson(),
      };
}
...
class Banner {
  ...
  int resourceId;
  String imageType;
  String? appSectionResourceType;
  String? appSectionResourceId;
  dynamic title;
  dynamic subTitle;
  dynamic buttonText;
...
class SectionProduct {
  ...
  factory SectionProduct.fromJson(Map<String, dynamic> json) => SectionProduct(
        id: json['id'],
