...
import 'numerologyview.dart';

class NumeroFormView extends StatefulWidget {
  const NumeroFormView({super.key});

  @override
  State<NumeroFormView> createState() => _NumeroFormViewState();
}

class _NumeroFormViewState extends State<NumeroFormView> {
  ...
  void _submitForm() {
    ...
    if (_nameController.text.isEmpty ||
      ...
      Navigator.push(
        context,
        CupertinoPageRoute(
            builder: (context) => NumerologyView(
