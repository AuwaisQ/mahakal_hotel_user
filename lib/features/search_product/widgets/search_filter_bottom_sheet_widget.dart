...
import 'package:mahakal/features/brand/domain/models/brand_model.dart';
              ...
              return Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "${PriceConverter.convertPrice(context, currentRangeValues.start)} - ",
                          ...
                          child: SizedBox(
                              ...
                              child: CustomButton(
                                  backgroundColor: Theme.of(context)
                                      ...
                                      .tertiaryContainer
                                      .withOpacity(.5),
                                  textColor: Provider.of<ThemeController>(
                                              context,
                                              listen: false)
                                          .darkTheme
                                      ? Colors.white
