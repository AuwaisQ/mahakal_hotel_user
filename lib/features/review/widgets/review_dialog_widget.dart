...
import 'package:mahakal/features/review/domain/models/review_body.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (reviewController.orderWiseReview != null &&
                        reviewController.orderWiseReview!.attachment != null &&
                        reviewController
                            .orderWiseReview!.attachment!.isNotEmpty)
                      Padding(
                          ...
                          child: SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount: reviewController
                                      .orderWiseReview?.attachment?.length,
                                          ...
                                          child: Container(
                                              ...
                                              child: ClipRRect(
                                                  ...
                                                  child: CustomImageWidget(
                                                    image:
                                                        "${Provider.of<SplashController>(context, listen: false).baseUrls?.reviewImageUrl}/review/${reviewController.orderWiseReview?.attachment?[index]}",
                                                  )))),
                                      Positioned(
                                          top: 0,
                                          right: 0,
