...
import 'package:mahakal/features/review/domain/models/review_model.dart';
...
import 'package:mahakal/common/basewidget/rating_bar_widget.dart';
        ...
        Row(children: [
          ClipRRect(
              ...
              child: FadeInImage.assetNetwork(
                  ...
                  fit: BoxFit.cover,
                  image:
                      '${Provider.of<SplashController>(context, listen: false).baseUrls!.customerImageUrl}/${reviewModel.customer != null ? reviewModel.customer!.image : ''}',
