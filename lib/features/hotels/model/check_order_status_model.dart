class CheckOrderStatusModel {
  ...
  factory CheckOrderStatusModel.fromJson(Map<String, dynamic> json){
...
class Bookings {
  ...
  final List<DraftHotelOrder> data;
  ...
  factory Bookings.fromJson(Map<String, dynamic> json){
    return Bookings(
      ...
      data: json["data"] == null ? [] : List<DraftHotelOrder>.from(json["data"]!.map((x) => DraftHotelOrder.fromJson(x))),
...
class DraftHotelOrder {
  ...
  final dynamic paid;
  final dynamic payNow;
  final dynamic walletCreditUsed;
  ...
  factory DraftHotelOrder.fromJson(Map<String, dynamic> json){
    return DraftHotelOrder(
      id: json["id"] ?? 0,
      code: json["code"] ?? "",
