...
class CheckoutService implements CheckoutServiceInterface {
  ...
  Future cashOnDeliveryPlaceOrder(
    ...
    return await checkoutRepositoryInterface.cashOnDeliveryPlaceOrder(addressID,
        couponCode, couponDiscountAmount, billingAddressId, orderNote);
  }
  ...
  Future walletPaymentPlaceOrder(
      ...
      String? billingAddressId,
      String? orderNote) async {
    return await checkoutRepositoryInterface.walletPaymentPlaceOrder(addressID,
        couponCode, couponDiscountAmount, billingAddressId, orderNote);
  }
}
