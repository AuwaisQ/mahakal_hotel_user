...
class AllScreenListData extends StatefulWidget {
  String purposeId;
  String type;

  AllScreenListData({super.key, required this.purposeId, required this.type});

  @override
  State<AllScreenListData> createState() => _AllScreenListDataState();
}

class _AllScreenListDataState extends State<AllScreenListData> {
  ...
  //         await ApiServiceDonate().getAdvertise(url, data);
  //     print(res);
  //
