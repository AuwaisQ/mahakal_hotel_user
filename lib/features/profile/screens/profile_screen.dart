...
import 'package:mahakal/features/profile/widgets/delete_account_bottom_sheet_widget.dart';
...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  updateUserEmail() async {
    ...
    if (email.isEmpty) {
    ...
    } else if (ValidateCheck.validateEmail(email) != null) {
      showCustomSnackBar(getTranslated('Enter Valid Email', context), context);
    } else {
      var isSuccess =
          await Provider.of<ProfileController>(context, listen: false)
      ...
      if (isSuccess) {
        ...
        showCustomSnackBar('Something Went wrong please try again!', context,
            isError: false);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    var email = Provider.of<ProfileController>(context, listen: false)
            .userInfoModel!
            .email ??
        '';
    return Scaffold(
                          ...
                          child: Stack(clipBehavior: Clip.none, children: [
                            ClipRRect(
                              ...
                              child: file == null
                                  ? CustomImageWidget(
                                      image:
                                          "${splashController.baseUrls!.customerImageUrl}/${profile.userInfoModel!.image}",
