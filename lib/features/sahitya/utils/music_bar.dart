...
class _MusicBarState extends State<MusicBar> {
  ...
  Widget build(BuildContext context) {
    final audioManager = Provider.of<AudioPlayerManagerSahitya>(context);
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Text(
                                  "${audioManager.currentMusic?.verse}",
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    overflow: TextOverflow.ellipsis,
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              audioManager.currentMusic?.verseData?.verseData
                                      ?.sanskrit
                                      .toString() ??
                                  '',
                              style: const TextStyle(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          ...
                          // audioManager.skipNext(chapterId: widget.chapterNumber);
                        },
                        icon: Icon(
                          Icons.skip_next,
                          color: Colors.white,
