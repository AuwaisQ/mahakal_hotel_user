...
import 'package:mahakal/features/sahitya/view/hanuman_chalisa/share_hanumanchalisa.dart';
import 'package:provider/provider.dart';
import 'package:screenshot/screenshot.dart';
import '../../../donation/ui_helper/custom_colors.dart';

class ShareChalisa extends StatefulWidget {
  ShareChalisa(
      {super.key,
      required this.hanumanChaupai,
      required this.chaupaiMeaning,
      required this.chalisaModel});

  final String hanumanChaupai;
  final String chaupaiMeaning;
  //final String? chapterName;
  //final int? chalisaSerial;

  HanumanChalisaModel? chalisaModel;

  @override
  State<ShareChalisa> createState() => _ShareChalisaState();
}

class _ShareChalisaState extends State<ShareChalisa> {
  final shareHanumanChalisa = ShareHanumanChalisa();
  ...
  final List<String> _images = [
    "assets/hanuman_chalisa_audio/hanumanji1.jpg",
    "assets/hanuman_chalisa_audio/hanumanji2.jpg",
    "assets/hanuman_chalisa_audio/hanumanji3.jpg"
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Screenshot(
                controller:
                    context.watch<ShareHanumanChalisa>().screenshotController,
                child: Container(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //   child: Text('${(widget.chapterName)}  श्लोक: ${widget.chalisaSerial}',textAlign: TextAlign.center,style: TextStyle(fontSize: screenWidth * 0.04,fontWeight: FontWeight.w600,color: CustomColors.clrwhite),),
                                    // ),
            ...
            Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: screenWidth * 0.2, vertical: screenWidth * 0.1),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Column(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: _selectedContainer == 0
                                  ? Border.all(
                                      color: CustomColors.clrskin, width: 4)
                                  : null),
                        ),
                      ),
                    ],
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  // ShareHanumanChalisa.ShareHanumanChalisa(widget.detailsModel!);
                  context
                      .read<ShareHanumanChalisa>()
                      .shareCustomDesign(widget.chalisaModel!, context);
                },
                child: Container(
                  decoration: BoxDecoration(
