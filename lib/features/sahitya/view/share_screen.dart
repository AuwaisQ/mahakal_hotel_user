...
class ShareScreen extends StatefulWidget {
  ShareScreen(
      {super.key,
      required this.gitaShlok,
      required this.shlokMeaning,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: screenWidth * 0.06),
                                      child: Text(
                                        '${(widget.chapterName)}  श्लोक: ${widget.verseSerial}',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            fontSize: screenWidth * 0.04,
                                            fontWeight: FontWeight.w600,
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  context
                      .read<ShareVerse>()
                      .shareCustomDesign(widget.detailsModel!, context);
                },
                child: Container(
                  decoration: BoxDecoration(
