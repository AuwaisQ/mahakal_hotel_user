...
class AudioPlayerManagerSahitya extends ChangeNotifier
  ...
  Future<void> playMusic(Verse music, int? chapterId) async {
    ...
    try {
      // AllAudioController().registerPlayer(_audioPlayer);

      final directory = await getApplicationDocumentsDirectory();
      // Correct file path with chapterId
      final audioFile =
          io.File('${directory.path}/chapter_$chapterId${music.verse}.mp3');
      ...
      if (await audioFile.exists()) {
        ...
        await _audioPlayer
            .play(); // Ensure to await this for smooth transitions
        ...
        print(
            "Audio file for verse ${music.verse} in chapter $chapterId not found");
      }
    } catch (error) {
