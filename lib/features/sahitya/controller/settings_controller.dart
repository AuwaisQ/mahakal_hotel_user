...
class SettingsProvider with ChangeNotifier {
  ...
  void updateHindiText() {
    _showHindiText = !_showHindiText;

    // If either Hindi or English text is shown, bookFormate must be false
    if (_showHindiText || _showEnglishText) {
      _showBookFormate = false;
    }
    notifyListeners();
  }

  void updateEnglishText() {
    _showEnglishText = !_showEnglishText;
  ...
  void onBookFormate() {
    ...
    // When bookFormate is true, both Hindi and English texts should not be displayed
    if (_showBookFormate) {
      _showHindiText = false;
      _showEnglishText = false;
    }
    notifyListeners();
  }
}
