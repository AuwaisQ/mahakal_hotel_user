...
ChaptersGita chaptersGitaFromJson(String str) =>
    ChaptersGita.fromJson(json.decode(str));
...
class ChaptersGita {
  ...
  factory ChaptersGita.fromJson(Map<String, dynamic> json) => ChaptersGita(
        status: json["status"],
        data: List<MyChapters>.from(
            json["data"].map((x) => MyChapters.fromJson(x))),
      );
...
class Translation {
  ...
  factory Translation.fromJson(Map<String, dynamic> json) => Translation(
        translationableType:
            translationableTypeValues.map[json["translationable_type"]]!,
  ...
  Map<String, dynamic> toJson() => {
        "translationable_type":
            translationableTypeValues.reverse[translationableType],
...
final keyValues = EnumValues({"name": Key.NAME});

enum Locale { IN }

final localeValues = EnumValues({"in": Locale.IN});

enum TranslationableType { APP_MODELS_BHAGAVAD_GITA_CHAPTER }

final translationableTypeValues = EnumValues({
  "App\\Models\\BhagavadGitaChapter":
      TranslationableType.APP_MODELS_BHAGAVAD_GITA_CHAPTER
});
