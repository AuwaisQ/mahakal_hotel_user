...
import 'package:mahakal/features/shop/domain/models/shop_again_from_recent_store_model.dart';
...
class SellerProductController extends ChangeNotifier {
  ...
  Future<ApiResponse> getSellerProductList(
      String sellerId, int offset, String productId,
      {bool reload = true,
      String search = '',
      String? categoryIds = '[]',
      String? brandIds = '[]'}) async {
    print("print karna he ecom product $offset");
    ApiResponse apiResponse = await sellerProductServiceInterface!
        .getSellerProductList(sellerId, offset.toString(), productId,
            categoryIds: categoryIds, brandIds: brandIds, search: search);
