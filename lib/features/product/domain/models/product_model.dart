...
class Product {
  ...
  Product({
    ...
    if (productRefundable != null) {
      _productRefundable = productRefundable;
    }
  ...
  int? get productRefundable => _productRefundable;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _addedBy = _cleanString(json['added_by']);
    _userId = json['user_id'];
    _name = _cleanString(json['name']);
    _slug = _cleanString(json['slug']);
    _productType = _cleanString(json['product_type']);
    ...
    _unit = _cleanString(json['unit']);
    _minQty = json['min_qty'];

    if (json['refundable'] != null) {
      _refundable = int.parse(json['refundable'].toString());
    }
    if (json['product_refund'] != null) {
      _productRefundable = int.parse(json['product_refund'].toString());
    }
    ...
    _details = _cleanString(json['details']);
    _createdAt = _cleanString(json['created_at']);
    _updatedAt = _cleanString(json['updated_at']);
    if (json['rating'] != null) {
      _rating = [];
