...
class OfflineAllScreen extends StatefulWidget {
  const OfflineAllScreen({super.key, required this.type});

  final String? type;
  @override
  State<OfflineAllScreen> createState() => _OfflineAllScreenState();
}

class _OfflineAllScreenState extends State<OfflineAllScreen> {
  ...
  Future<void> getSubCategory() async {
    ...
    try {
      final url = "${AppConstants.panditSubCategoryUrl}${widget.type}";
