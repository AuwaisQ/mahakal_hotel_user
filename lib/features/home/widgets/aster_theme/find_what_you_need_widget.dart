                                                      ...
                                                      ClipRRect(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child:
                                                            ...
                                                            fit: BoxFit.cover,
                                                            image:
                                                                '${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.categoryImageUrl}/${productController.findWhatYouNeedModel!.findWhatYouNeed![index].childes?[subIndex].icon}',
                                                          ),
                                                        ),
                                                      ),
                                                      const SizedBox(
