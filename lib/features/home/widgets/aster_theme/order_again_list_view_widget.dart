...
import 'package:mahakal/features/order/domain/models/order_model.dart';
import 'package:mahakal/features/reorder/controllers/re_order_controller.dart';
import 'package:mahakal/helper/date_converter.dart';
                                    ...
                                    onTap: () {
                                      showDialog(
                                          ...
                                          builder: (_) => ImageDialog(
                                              imageUrl:
                                                  '${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productThumbnailUrl}/${orders.details?[detailsIndex].product?.thumbnail ?? ''}'));
                                    },
                ...
                Row(children: [
                  ...
                  SizedBox(
                      ...
                      child: CustomButton(
                          ...
                          onTap: () {
                            Provider.of<ReOrderController>(context,
                                    listen: false)
