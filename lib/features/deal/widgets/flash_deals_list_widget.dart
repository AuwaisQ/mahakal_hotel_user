...
import 'package:mahakal/features/deal/widgets/flash_deal_card_widget.dart';
                ...
                ? flashDealController.flashDealList.isNotEmpty
                    ? CarouselSlider.builder(
                        options: CarouselOptions(
                            viewportFraction:
                                ResponsiveHelper.isTab(context) ? .5 : .7,
                            autoPlay: true,
                        ...
                        itemBuilder: (context, index, _) => FlashDealWidget(
                                                            ...
                                                            PriceConverter.convertPrice(
                                                                ...
                                                                flashDealController
                                                                    .flashDealList[
                                                                        index]
                                                                    .unitPrice,
                                                                discountType: flashDealController
                                                                    .flashDealList[
                                                                        index]
                                                                    .discountType,
                                                                discount: flashDealController
                                                                    .flashDealList[
                                                                        index]
                                                                    .discount),
