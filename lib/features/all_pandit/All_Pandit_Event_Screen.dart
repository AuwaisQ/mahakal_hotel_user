...
class _AllPanditEventScreenState extends State<AllPanditEventScreen> {
  ...
  void searchItems(String value) {
    ...
    setState(() {
      filteredList = fullList.where((item) {
        final name = item.enTitle?.toLowerCase() ?? '';
        final venue = item.enTitle?.toLowerCase() ?? '';
  ...
  Widget buildEventCard(Event eventDetails, {bool isList = false}) {
    return InkWell(
      ...
      // ),
      child: Container(
        margin: isList ? const EdgeInsets.only(bottom: 12) : null,
              ...
              child: Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.network('${eventDetails.eventImage}',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    widget.isLanguage
                        ? '${eventDetails.enTitle}'
                        : '${eventDetails.hiTitle}',
                    maxLines: 1,
                  ...
                  Text(
                    widget.isLanguage
                        ? '${eventDetails.enVenueName}'
                        : '${eventDetails.hiVenueName}',
                    maxLines: 2,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        //   context,
                        //   CupertinoPageRoute(
                        //     builder: (_) => EventDeatils(eventId: eventDetails.id,),
                        //   ),
                        // );
                      },
                      child: Text(widget.isLanguage
                          ? 'Book Now'
                          : 'अभी बुक करें',
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  widget.isLanguage ? gurujiInfo?.guruji?.enName ?? '' : gurujiInfo?.guruji?.hiName ?? '',
