...
import 'package:mahakal/features/event_booking/model/event_reviewmodel.dart';
import 'package:intl/intl.dart';
import 'package:readmore/readmore.dart';
import '../../tour_and_travells/widgets/PRatingBarIndicater.dart';

class EventUserReviewCard extends StatelessWidget {
  final EventListModel comment;

  const EventUserReviewCard({super.key, required this.comment});
